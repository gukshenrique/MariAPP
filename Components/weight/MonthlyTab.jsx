...
export default function MonthlyTab({ entries, goal }) {
    ...
    // Chart data
    const chartData = currentMonthEntries.map(e => ({
        date: format(parseISO(e.date), 'd'),
        peso: e.weight
    }));
    ...
    return (
        <div className="space-y-6">
            ...
            {chartData.length > 1 && (
                ...
                >
                    <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-4">Evolução do Mês</h3>
                    <div className="h-48">
